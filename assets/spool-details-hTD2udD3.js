...
- **Remove from Inventory** — a submenu with **Sold**, **Gifted**, and **Discarded**. The spool keeps its full record but leaves your current inventory. See [Editing and deleting spools](/docs/inventory/editing-and-deleting-spools/).\r
- **Mark Used Up** — flag the spool as used up. If filament is still on it, you are asked whether to mark it discarded instead. You can undo this.\r
- **Restore to Inventory** — shown only on a spool that has left inventory; puts it back as active and clears its recorded exit details, after a confirmation.\r
- **Delete spool** — remove the spool entirely. See [Editing and deleting spools](/docs/inventory/editing-and-deleting-spools/).\r
\r
