...
description: Pro is not recognised, or your credit balance looks wrong.
order: 5
status: published
updated: 2026-08-04
keywords:
...
There is no restore button on Windows. The app checks your Microsoft Store licence every time it opens. If Pro is missing, fully quit the app and open it again. Receipt validation needs a Spool Hoarder account, so sign in from the Account & Subscription screen too.
...
Your credit balance reads **N scan credits remaining**. It appears on iPhone, iPad, Mac, and Android. On Windows and Web the line is hidden, but the credits still exist on your account and apply when you scan on another device.
...
To buy a pack, open Account & Subscription and tap **Buy 25 AI Credits**. Success shows **Credits added!**

## The free-tier limits

Without Pro or an active trial, the free version supports up to **50 spools, 5 projects, and 1 printer profile**. If a purchase is not recognised and you hit one of these limits, restore or sign in before adding more.
