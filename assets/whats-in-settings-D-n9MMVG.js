...
- **About Spool Hoarder** — the app version, credits, open source licenses, and links to the [privacy policy](/privacy-policy/) and [terms of use](/terms-of-use/). Quote the version here when you write to us.
...
Everything else in the list is on every platform, though what a given entry offers can still differ — buying a credit pack, for instance, is available on iPhone, iPad, Mac, and Android, but not on Windows.
