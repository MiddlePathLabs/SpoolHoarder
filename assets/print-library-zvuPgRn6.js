...
- **Add Files** — copy new STL or 3MF files into the root. They land in
  **Needs Review** until you organise them.
- **Rescan** — re-index the root to pick up files added outside the app.
- **Organize Library** — open the organise preview to tidy the folder structure.
...
the model grid or list in the centre, and an inspector on the right. On a compact
...
- **Workflow** — **Needs Review** (files you added but have not organised yet),
...
From there you can organise the selection, move it to Trash, archive it, or add
...
OrcaSlicer, Bambu Studio, Cura, or Blender. Spool Hoarder recognises known apps
from their filename; custom apps can be renamed.

## Related pages

- [Organising model files](/docs/organizing/organizing-model-files/)
