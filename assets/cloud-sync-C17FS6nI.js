...
\r
Deletes are the one exception: a delete always wins. Once a record is deleted on\r
one device, it stays deleted everywhere, even if another device has a newer edit\r
or a re-imported copy waiting to sync. Re-adding the record afterwards creates a\r
fresh entry that syncs normally.\r
\r
