...
- **Group by product** — combines spools with the same brand, material, product family, name, and colour. This is the default.
...
## Labelling spools with features
...
- **Shown on cards** — you can turn it on under [Customising spool cards](/docs/inventory/customizing-spool-cards/).
...
## How favourites interact with grouping

Favourites are not pinned to the top of the list by default. When you turn on the **Favorites** filter and use a flat list, you can drag your favourited spools into a custom order — see [Favourites and low stock](/docs/inventory/favorites-and-low-stock/) for the details. In any other mode, favourites follow whatever sort you have chosen.
