...
Organise Library builds a tidy folder structure for the models in your library
...
Organise Library is desktop-only, like the rest of the
[Print Library](/docs/organizing/print-library/). The preview is free; applying
the changes requires an active trial or Pro.

## Open the organise preview

You can start organising from several places:
