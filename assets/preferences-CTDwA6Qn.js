const e=`---
title: Preferences
description: The behavior settings — AI recognition, spool defaults, low-stock warnings, catalog sharing, and Spoolman.
order: 3
status: published
updated: 2026-08-04
keywords:
...
- **Color Advisor Suggestions** — shows color-theory pairing suggestions when adding filaments to a project. On by default.
...
- **Community Barcode Catalog** — recognizes barcodes confirmed by other users and shares your confirmed scans. Prices and purchase info are never shared. On by default.
...
This section appears on iOS, iPadOS, macOS, and Android. It is not shown on Windows.
