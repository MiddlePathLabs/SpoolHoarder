...
A depleted spool is grayed out and sorts below active spools. Its **Log Usage** and **Start Project** buttons are disabled until you undo it or correct the weight.
...
Yes. On iPhone, iPad, Mac, and Windows the free tier allows up to **50 spools**, and that count is based on the spools currently in your inventory. Deleting one frees its slot so you can add another. A Pro subscription removes the limit everywhere.
