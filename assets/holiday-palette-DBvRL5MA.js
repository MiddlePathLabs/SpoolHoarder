...
description: Seasonal colour suggestions matched against what you have in stock.
order: 4
status: published
updated: 2026-08-04
keywords:
...
When a holiday or observance is near, Spool Hoarder can suggest seasonal colours
for the spool you are viewing, drawn from the filaments you already have. It is
part of the Colour Advisor, so it appears in the same **Color Suggestions** card
on a spool's detail screen.

A holiday palette only appears when the spool's own colour already fits the
...
that fill out that holiday's colours, and offers shop suggestions for the colours
you are missing.
...
The 14-day window and the colour-matching tolerance are built in; there are no
...
off and both the colour-theory palettes and the holiday palettes disappear. See
[Colour Advisor](/docs/planning/color-advisor/) for the full detail.
...
- [Colour Advisor](/docs/planning/color-advisor/)
