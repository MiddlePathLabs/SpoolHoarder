...
- If you have saved a calculator estimate to the project, it shows that, labeled
  **Estimate**.
...
- **Project cost is backward-looking and filament-only.** It is the actual
  weight you used, priced from your spools after the print.
- **The [Print cost calculator](/docs/planning/print-cost-calculator/) is
  forward-looking.** It estimates a planned print and can include electricity,
  printer wear, labor, a failure-rate margin, markup, shipping, and more, on top
  of the filament.
