...
## The brand or color is wrong

AI scans fill only the fields that are empty on your form, and they never overwrite values you already typed. If the brand or color came through wrong, edit the field directly before you save.
...
AI photo scanning runs on Android, iOS, and macOS only. On Windows the **Scan with AI** section is hidden and you see **Photo scanning is available on Android, iOS, and macOS.**

On Windows the batch scanner also has no live camera. Use **Upload spool image** to pick a photo from your files instead.
