...
description: Light, dim, and dark modes, the color palettes, and the display options that change how the inventory looks.
order: 2
status: published
updated: 2026-08-04
keywords:
...
**Palette** sets the accent color used for buttons, switches, and highlights. There are four:

- **Copper** (the default) — warm brown.
- **Twilight** — purple.
- **Dragon** — teal.
- **Onyx** — near-monochrome gray. Color only appears where it carries meaning, such as status indicators.

Each palette is tuned for light, dim, and dark, so you can combine any palette with any theme.

## Motion and card icons

- **Reduce Motion** minimizes animations throughout the app.
...
- **Product** (the default) — groups spools that share the same brand, material, name, and color.
...
**Spool Card Display Fields** chooses which extra details appear on each spool card. Brand, material, and color are always shown. On top of those, you can pick up to **four** of:
...
Once four are selected, deselect one to choose another. See [Customizing spool cards](/docs/inventory/customizing-spool-cards/).
