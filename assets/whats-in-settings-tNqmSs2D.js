...
- **Account & Subscription** — plan, sign-in, cloud sync, purchases, and scan credits.
  ...
  - **Manage Subscription**, which appears on iPhone, iPad, and Mac once you are subscribed: [Managing or cancelling](/docs/account/managing-or-cancelling/)
...
- **Appearance** — theme, colour palette, how the Inventory tab groups spools by default, and which fields show on a spool card. See [Appearance and themes](/docs/settings/appearance-and-themes/) and [Customizing spool cards](/docs/inventory/customizing-spool-cards/).
- **Preferences** — defaults, AI scanning, and integrations. See [Preferences](/docs/settings/preferences/).
  ...
  - The Colour Advisor toggle: [Colour Advisor](/docs/planning/color-advisor/)
...
- **About Spool Hoarder** — the app version, credits, open source licences, and links to the [privacy policy](/privacy-policy/) and terms of use. Quote the version here when you write to us.
...
Everything else in the list is on every platform, though what a given entry offers can still differ — buying a credit pack, for instance, is an Apple-only purchase.
