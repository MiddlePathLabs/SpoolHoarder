...
filaments you planned to use, the usage you logged afterward, and the running
...
Everything else is added from inside the project afterward:
...
On iPhone, iPad, Mac, Android, and Windows, the free tier supports up to five projects.
The Personal Log is not counted. If you try to create a sixth, Spool Hoarder
offers an upgrade to Spool Hoarder Pro for unlimited projects.
