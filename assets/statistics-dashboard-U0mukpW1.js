...
- **Left Inventory** — the exit ledger. It appears only once something has actually\r
  left your inventory, and covers how spools left (sold, gifted, discarded), what\r
  the sales brought in against what those spools cost, the value you gave away or\r
  wrote off, and the average filament still on a spool when it left. Sales with no\r
  recorded amount are called out separately, with a link to fill them in, because\r
  they sit outside every money figure here. Each card opens the matching filtered\r
  inventory.\r
\r
### Projects\r
\r
