...
On Android, iOS, and macOS, a **Scan with AI** button sits at the top of the form. Take a photo of a spool label and Spool Hoarder reads the brand, material, color, weight, and temperatures off it, then fills the empty fields for you to review. Photo scanning is not available on Windows.
...
The form is organized into collapsible sections. The sections that already have data expand automatically when you are editing a spool.
...
- **Color Description** — type a color name and Spool Hoarder searches the public catalog for matching filaments, showing swatches as you type. Picking one fills in the hex codes, diameter, spool size, temperatures, and other details for that filament.
- **Colors** — tap a color-family chip (Black, White, Gray, Red, Orange, Yellow, Green, Blue, Purple, Pink), or tap **Edit** for the full set of sixteen families.
...
- **Transmission Distance (TD)** — a light-transmission value used for color matching. Must be between 0.1 and 100.
...
On the free tier, you can store up to **50 spools** on iPhone, iPad, Mac, and Windows. A Pro subscription removes the limit. Deleting a spool frees its slot back up.
