...
| **Invalid colorHexCodes: ...** | A color code is malformed. | Use hex codes like \`#FF8800\`, separated by semicolons. |
| **Date parse error for createdAt: ...** | A date is not a recognized format. | Use an ISO date such as \`2026-08-04\`. |
